(()=>{(function(){let d={"dp:4.20.1":{text:"2.0",className:"version-outdated",title:"Drawpile 2.0 (not compatible with Drawpile 2.3)"},"dp:4.21.2":{text:"2.1",className:"version-outdated",title:"Drawpile 2.1 (not compatible with Drawpile 2.3)"},"dp:4.24.0":{text:"2.2",className:"version-compatible",title:"Drawpile 2.2 (compatible with Drawpile 2.3)"},"dp:4.25.1":{text:"2.3",className:"version-current",title:"Drawpile 2.3"}},f={text:"???",className:"version-unknown",title:"Unknown Version"},p=["dp:4.24.0"],t=(s,o={},...l)=>{let i=document.createElement(s);return Object.entries(o).forEach(([e,r])=>{r instanceof Function?i.addEventListener(e,r):i.setAttribute(e,r)}),l.forEach(e=>{typeof e=="string"&&(e=document.createTextNode(e)),i.appendChild(e)}),i},a=(...s)=>t("td",{},...s),h=(s,o)=>t("div",{class:"root"},t("div",{class:"filters"},t("div",{class:"filter"},t("input",{type:"checkbox",id:"filter-password"}),t("label",{for:"filter-password"},"\u{1F512} Password")),t("div",{class:"filter"},t("input",{type:"checkbox",id:"filter-closed"}),t("label",{for:"filter-closed"},"\u{1F6AA} Closed (block new logins)")),t("div",{class:"filter"},t("input",{type:"checkbox",id:"filter-allowweb"}),t("label",{for:"filter-allowweb"},"\u{1F310} Can join via Web browser")),...o?[t("div",{class:"filter"},t("input",{type:"checkbox",id:"filter-nsfm"}),t("label",{for:"filter-nsfm"},"\u{1F51E} Not suitable for minors (NSFM)"))]:[]),t("div",{class:"listings"},t("table",{},t("colgroup",{},t("col",{width:"0%"}),t("col",{width:"100%"}),t("col",{width:"0%"}),t("col",{width:"0%"}),t("col",{width:"0%"}),t("col",{width:"0%"}),t("col",{width:"0%"})),t("thead",{},t("tr",{},t("th"),t("th",{class:"sortable sorted-desc","data-column":"title",click:s},"Title"),t("th",{class:"sortable","data-column":"host",click:s},"Server"),t("th",{class:"sortable","data-column":"owner",click:s},"Started by"),t("th",{class:"sortable","data-column":"users",click:s},"Users"),t("th",{class:"sortable","data-column":"activedrawingusers",click:s},"Active"),t("th",{class:"sortable","data-column":"started",click:s},"Uptime"),t("th",{class:"sortable","data-column":"protocol",click:s},"Version"),t("th"))),t("tbody",{},t("tr",{},t("td",{class:"loading",colspan:6},"Loading...")))))),u=s=>Number.isInteger(s)&&s>=0?`${s}`:"",b=(s,o)=>{let l=Date.parse(s),i=(o-l)/6e4,e=Math.floor(i/1440),r=Math.floor(i/60-e*24),n=Math.floor(i-e*1440-r*60);return e>0?`${e}d ${r}h ${n}m`:r>0?`${r}h ${n}m`:`${n}m`},m=s=>{let o=[];return s.password&&o.push(t("span",{title:"Password"},"\u{1F512}")),s.closed&&o.push(t("span",{title:"Closed (block new logins)"},"\u{1F6AA}")),s.nsfm&&o.push(t("span",{title:"Not suitable for minors (NSFM)"},"\u{1F51E}")),s.allowweb&&o.push(t("span",{title:"Can join via Web browser"},"\u{1F310}")),o},w=s=>{let o=d[s.protocol]||f;return t("span",{class:"flair "+o.className,title:o.title},o.text)},g=s=>{let o=s.port===27750?s.host:`${s.host}:${s.port}`,l=encodeURIComponent(o),i=encodeURIComponent(s.id),e=[];s.allowweb&&e.push("web"),s.nsfm&&e.push("nsfm"),s.password&&e.push("pw");let r=e.length===0?"":`?${e.join("&")}`;return`https://drawpile.net/invites/${l}/${i}${r}`},v=(s,o,l)=>{let i={title:s,href:o,class:"btn",target:"_blank"};return l&&(i.disabled="true"),t("a",i,"Join")},x=(s,o)=>{let l=localStorage.getItem(s);return l===null?o:l==="1"},k=(s,o)=>{localStorage.setItem(s,o?"1":"")};class _ extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._sessions=[],this._sortColumn="title",this._sortDir=-1,this._filters={}}connectedCallback(){let o=this.getAttribute("list-url"),l=!!o.match(/[?&]nsfm=true\b/i),i=t("style",{},`
			.root {
				background: #fcfcfc;
				color: #232629;
