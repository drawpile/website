...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if action == 'purge-unused':
            ...
            raise CommandError("Action must be one of: purge-unused")
    ...
    def __purge_unused(self, older):
        ...
        if self.dryrun:
            print("Would delete {} accounts that have not logged in since {}".format(
                unused_accounts.count(),
                cutoff
                ))
            ...
            if self.verbosity > 1:
                print("Deleted {} accounts that have not logged in since {}".format(
                    deleted_count,
                    cutoff
                    ))
